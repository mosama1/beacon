...
<div id="agregarHorario" class="modal modal_">
	...
	<div class="form">
		<form class="form-horizontal form_send" role="form" method="POST" action="{{ route('store_timeframe') }}">
			{{ csrf_field() }}
			...
			<div class="input no_icon {{ $errors->has('start_time') ? 'error' : '' }} time">
				...
				<label for="">
					<span class="text">Hora de inicio (hh:mm)</span>
				</label>
				<div class="help">
					<a href="#">
						<i class="material-icons">help_outline</i>
			...
			<div class="input no_icon {{ $errors->has('end_time') ? 'error' : '' }} time">
				...
				<label for="">
					<span class="text">Hora de finalización (hh:mm)</span>
				</label>
				<div class="help">
					<a href="#">
						<i class="material-icons">help_outline</i>
